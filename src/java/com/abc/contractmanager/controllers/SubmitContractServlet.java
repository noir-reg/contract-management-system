...
public class SubmitContractServlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            ContractDTO contract = ContractDAO.getContractDetail(String.valueOf(CoID));
            RoomDAO.updateRoomIn(contract.getUID(), contract.getRoID());
            request.setAttribute("noti", "Submit contact successed");
